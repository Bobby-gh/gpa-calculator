...
/**
 * @description A program to calculate the GPA of university students whose uses
 *              a GPA system of 4.0 or 5.0.
 * @author alexander
 * @date 18/07/2021
 */
public class Main {
    public static void main(String[] args) {
        // This part of the code displays the menu panel where the user enters the the
        // GPA system he\she school runs
        // and also the number of courses taken in the semester for the GPA is to be
        // calculated from.
        Scanner input = new Scanner(System.in);
        // receives input for GPA system
        System.out.println("================= GPA CALCULATOR ===============================");
        System.out.println(
                " Enter the GPA system your school runs:\n For 4.0 GPA system enter: 4 \t\tFor 5.0 GPA system enter: 5 ");
        System.out.println("================================================================");
        int gpa = input.nextInt();
        // this part works on code in parenthesis and throws and exceptional error when
        // GPA system entered is not 4 or 5.
        try {
            if (gpa == 4 || gpa == 5)
                // displays input entered
                System.out.println(" GPA system: " + gpa);
        } catch (InputMismatchException ex) { // this stops the code and displays error message for inputs not 4 or 5'
    ...
    // this method performs all the necessary inputs:grades,credit hours,course
    // codes. and calculations involved in calculating GPA.
    // It also receives two parameters of integer type containing information about
    // number of courses and GPA system used.
    public static void enquiryAndGPACalculation(int c, int g) {
        ...
        if (g == 4) {
            for (int j = 0; j < c; j++) {
                // this part accepts inputs from the user about grading system and calls an
                // exception error if a wrong grading system is used.
                try {
